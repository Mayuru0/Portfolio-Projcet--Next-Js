...
const Social: React.FC<SocialProps> = ({ Cstyle }) => {
  const socialMedia = [
    ...
    { icon: <FaYoutube className='text-[#FF0000] w-9 h-9 hover:scale-110 transition-transform duration-300 hover:opacity-80' />, path: "https://www.youtube.com/@0_madhuranga_0" },
