    ...
    <div className="border border-gray-800 rounded-r-2xl text-white flex flex-col md:flex-row p-4 md:p-8 lg:p-12 mt-2">
      ...
      <div className="flex-1 mt-6 md:mt-0">
        <div className="space-y-8">
          <h1 className="text-4xl font-mono mb-6 bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent animate-pulse " data-aos="fade-down">Experience</h1>
          ...
          <div className="text-gray-300 leading-relaxed" data-aos="fade-up">
            <p>
              ...
              students learned how to use the GitHub web application effectively
              and concentrated on developing code that was clear, effective, and
          ...
          <div className="bg-[#252525] rounded-lg p-6 mt-8 w-1/2" data-aos="zoom-out">
            ...
            <div className="mt-4 flex items-center animate-bounce">
              ...
              <Link href='https://cypsolabs.com/' className="cursor-pointer hover:text-blue-600 hover:underline ">Cypso Labs PVT LTD</Link>
            </div>
          </div>
        </div>
      </div>
